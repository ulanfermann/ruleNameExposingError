...
/*#__PURE__*/
function () {
  function TwigTranspiler(input, context, depth) {
    if (depth === void 0) {
      depth = 0;
    }
  ...
  var _proto = TwigTranspiler.prototype;
    ...
    program.body.forEach(function (statement) {
      switch (statement.type) {
        ...
        case 'MustacheStatement':
          ...
          var escaped = statement.escaped ? '' : '|raw';
          var variable;
            ...
            case 'if':
              {
                ...
                var t = new TwigTranspiler(null, _this.context, _this.depth);

                _this.buffer.push(t.parseProgram(statement.program).toString());

                if (statement.inverse) {
                  // else section
                  var isInverseOnlyConditional = TwigTranspiler.isOnlyCondition(statement.inverse);

                  var _t = new TwigTranspiler(null, _this.context, _this.depth);
            ...
            case 'each':
              {
                ...
                var _t2 = new TwigTranspiler(null, childContext, _this.depth + 1);
                ...
                if (childScope.iterationType === _Context.IterationType.ARRAY) {
                  ...
                  _this.buffer.push("{% for " + key + ", " + value + " in " + _condition + "|cast_to_array %}");
                }
            ...
            default:
              {
                ...
                var _t3 = new TwigTranspiler(null, _this.context, _this.depth);
        ...
        case 'PartialStatement':
          {
            ...
            if (statement.params.length) {
              ...
              context = " with " + _this.context.getScopedVariable(statement.params[0]);
            }
  ...
  TwigTranspiler.isOnlyCondition = function isOnlyCondition(program) {
...
exports.TwigTranspiler = TwigTranspiler;